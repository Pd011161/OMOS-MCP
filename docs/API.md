...
|---|---|---|---|
| `400` | body ไม่ใช่ JSON / ไม่มี field ที่บังคับ / transcript เกิน 1 MB | `false` | แก้ payload |
...
- **ขนาด:** transcript + translation รวมกันไม่เกิน 1 MB (~350,000 ตัวอักษรไทย) — เพดานนี้มาจาก Google Docs ที่รับได้ ~1.02 ล้านตัวอักษรต่อไฟล์
